...
2025年12月、CursorがDebug Modeを発表しました。Cursor 2.2で導入された新しいエージェントモードで、従来の「コードを読んで即座に修正を生成する」アプローチとは根本的に異なるものです。
...
CursorのDebug Modeも同じ思想です。難解なデバッガツールではなくテキストログという最もプリミティブな手法を、極めて効率的に運用している。
